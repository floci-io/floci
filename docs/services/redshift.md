...
| `CreateIntegration` | Register a zero-ETL integration (metadata only; no data is replicated) |
| `DescribeIntegrations` | List integrations, or the one an `IntegrationArn` names |
