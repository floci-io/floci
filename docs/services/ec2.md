...
The opt-in [native AL2023 worker workflow](https://github.com/floci-io/floci/blob/main/tools/eks-native/README.md)
generates a complete catalog with a local worker entry without modifying the packaged JAR.
