...
clients, the AWS IoT Device SDK's WebSocket transport and secure tunnelling. With `443:4566`
published in Docker the AWS URL `wss://<endpoint>:443/mqtt` works unchanged. The handshake echoes
