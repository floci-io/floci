...
/**
 * A JSON POST without an X-Amz-Target header must fail like AWS does with
 * UnknownOperationException (404), not be served as an empty success. Both the
 * JSON 1.0 and JSON 1.1 controllers share the null-target branch.
 */
@QuarkusTest
class UnknownOperationMissingTargetIntegrationTest {
    ...
    void json10RequestWithoutTargetReturnsUnknownOperation() {
        ...
        .then()
            ...
            .body("message", equalTo("Unknown operation: null"));
    }
