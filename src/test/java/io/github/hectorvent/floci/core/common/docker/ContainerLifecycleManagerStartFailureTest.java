...
class ContainerLifecycleManagerStartFailureTest {
    ...
    void startCreatedAssignsTheStaticAddressBeforeStartingTheContainer() {
        ContainerSpec staticNetworkSpec = new ContainerSpec(
                "busybox:latest", null, List.of(), null, null, null, Map.of(), List.of(), List.of(),
                "test-network", "172.20.0.20", List.of(), List.of(), List.of(), List.of(), Map.of(),
                null, false, null, List.of(), null, null, List.of(), List.of(), null, null, false);
