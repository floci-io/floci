...
class CloudFormationServiceRollbackTest {
    ...
    @Test
    void createRollback_withAlreadyDeletedResource_reachesRollbackComplete() throws Exception {
        ...
        rollbackFailedCreate(stack, failed);
    ...
    private void rollbackFailedCreate(Stack stack, StackResource failed) throws Exception {
        Method method = CloudFormationService.class.getDeclaredMethod(
                "rollbackFailedExecution", Stack.class, String.class, boolean.class, StackResource.class);
        method.setAccessible(true);
        method.invoke(service, stack, REGION, true, failed);
    }
