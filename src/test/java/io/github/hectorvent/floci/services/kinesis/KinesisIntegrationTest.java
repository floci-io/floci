...
class KinesisIntegrationTest {
    ...
    void listShardsPaginatesWithNextTokenAndExhausts() {
        ...
        int pages = 0;
        do {
            Response response = listShardsPage("kinesis-pagination-test", 1, nextToken);
    ...
    @Test
    @Order(69)
    void listShardsRejectsATokenFromAnotherStream() {
        createStream("kinesis-pagination-a", 2);
        createStream("kinesis-pagination-b", 2);
        ...
        listShardsPage("kinesis-pagination-b", 1, token)
            .then()
            .statusCode(400)
            .body("__type", equalTo("InvalidArgumentException"));
    }
