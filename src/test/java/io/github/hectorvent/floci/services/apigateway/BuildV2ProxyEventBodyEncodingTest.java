...
class BuildV2ProxyEventBodyEncodingTest {
    ...
    private static Stream<Arguments> bodyEncodingCases() {
        return Stream.of(
                ...
                arguments("text/html UTF-8", "text/html; charset=utf-8", REQUEST_BODY, TEXT_BODY, false),
                arguments("text/csv UTF-8", "text/csv; charset=utf-8", REQUEST_BODY, TEXT_BODY, false),
                ...
                arguments("application/xml UTF-8", "application/xml; charset=utf-8", REQUEST_BODY, TEXT_BODY, false),
                arguments("application/javascript UTF-8", "application/javascript; charset=utf-8",
                        REQUEST_BODY, TEXT_BODY, false),
                arguments("application/graphql UTF-8", "application/graphql; charset=utf-8",
                        REQUEST_BODY, TEXT_BODY, false),
