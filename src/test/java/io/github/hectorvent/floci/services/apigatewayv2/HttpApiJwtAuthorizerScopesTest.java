...
class HttpApiJwtAuthorizerScopesTest {
    ...
    private static final String ISSUER = "https://example.com/pool";
    ...
    @Test
    @Order(12)
    void scopedRouteRejectsTokenWithoutMatchingScope() {
    ...
    /** Unsigned JWT (floci's JWT authorizer validates claims, not signatures). */
