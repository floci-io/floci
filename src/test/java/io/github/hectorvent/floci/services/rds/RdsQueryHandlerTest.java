...
class RdsQueryHandlerTest {
    ...
    void createDbInstance_passesStorageAndBackupSettingsToService() {
        ...
        p.add("PerformanceInsightsRetentionPeriod", "731");
        p.add("EngineLifecycleSupport", "open-source-rds-extended-support-disabled");
        p.add("MaxAllocatedStorage", "100");
        ...
        assertEquals(731, settings.performanceInsightsRetentionPeriod());
        assertEquals("open-source-rds-extended-support-disabled", settings.engineLifecycleSupport());
        assertEquals(100, settings.maxAllocatedStorage());
    ...
    void describeDbInstances_emitsStoredStorageAndBackupSettings() {
        ...
        instance.setPerformanceInsightsRetentionPeriod(731);
        instance.setEngineLifecycleSupport("open-source-rds-extended-support-disabled");
        instance.setMaxAllocatedStorage(100);
        ...
        assertTrue(body.contains("<PerformanceInsightsRetentionPeriod>731</PerformanceInsightsRetentionPeriod>"), body);
        assertTrue(body.contains("<EngineLifecycleSupport>open-source-rds-extended-support-disabled</EngineLifecycleSupport>"), body);
        assertTrue(body.contains("<MaxAllocatedStorage>100</MaxAllocatedStorage>"), body);
    ...
    void modifyDbInstance_passesBackupSettingsToService() {
        ...
        p.add("CopyTagsToSnapshot", "true");
        p.add("MonitoringInterval", "5");
        p.add("MonitoringRoleArn", "arn:aws:iam::123456789012:role/rds-monitoring-updated");
        p.add("EnablePerformanceInsights", "true");
        p.add("PerformanceInsightsRetentionPeriod", "93");
        p.add("EngineLifecycleSupport", "open-source-rds-extended-support");
        p.add("MaxAllocatedStorage", "120");
        p.add("CloudwatchLogsExportConfiguration.EnableLogTypes.member.1", "iam-db-auth-error");
        p.add("CloudwatchLogsExportConfiguration.DisableLogTypes.member.1", "upgrade");
        ...
        assertEquals(new DbInstanceSettings(null, null, 3, "01:00-01:30", null, true,
                5, "arn:aws:iam::123456789012:role/rds-monitoring-updated", true, 93,
                "open-source-rds-extended-support", 120,
                List.of("iam-db-auth-error"), List.of("upgrade")), captor.getValue());
    }
