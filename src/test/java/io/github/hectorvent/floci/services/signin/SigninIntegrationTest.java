...
class SigninIntegrationTest {
    ...
    void authorizePresentsLocalConsentPageBeforeRedirectingWithCode() throws Exception {
        ...
        assertEquals("/signin/consent", consent.getPath());
        String page = request()
                .get(location)
                .then()
                .statusCode(200)
        ...
        assertTrue(page.contains("src=\"/signin/floci-header.svg\""));
        assertTrue(page.contains("alt=\"Floci\""));
        assertTrue(page.contains("href=\"/signin/floci.svg\""));
        assertTrue(page.contains("href=\"/signin/signin.css\""));
        assertTrue(page.contains("Continue"));

        request()
                .get("/signin/floci-header.svg")
                .then()
                .statusCode(200)
