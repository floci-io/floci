        ...
        try {
            ...
            String page = """
                    ...
                    <head>
                      ...
                      <link rel="icon" href="/signin/floci.svg" type="image/svg+xml">
                    ...
                    <body>
                      <main class="shell">
                        <header class="brand">
                          <img src="/signin/floci-header.svg" alt="Floci" width="190" height="56">
                        ...
                        <section class="content">
                          ...
                          <form method="post" action="/signin/consent">
