...
// resolver would mix one's errors and auth type into the other. Serialising costs nothing here —
// handlers are short — and removes the whole class of cross-talk.
